...
⇐-preserve (⊢-+ ⊢ₗ ⊢ᵣ) (D-β-+ Vₗ Vᵣ) P₀ (D-β-φ V) = P₀ (⊢-+ ⊢ₗ ⊢ᵣ)
⇐-preserve (⊢-+ ⊢ₗ ⊢ᵣ) (D-β-+ Vₗ Vᵣ) P₀ (D-β-δ V) = P₀ (⊢-+ ⊢ₗ ⊢ᵣ)
⇐-preserve (⊢-φ ⊢ₚ ⊢ₑ) (D-ξ-φ D) P₀ (D-ξ-φ C) = ⊢-φ ⊢ₚ (⇐-preserve ⊢ₑ D P₀ C)
⇐-preserve (⊢-φ ⊢ₚ ⊢ₑ) (D-β-φ V) P₀ (D-β-· Vₗ Vᵣ) = P₀ (⊢-φ ⊢ₚ ⊢ₑ)
⇐-preserve (⊢-φ ⊢ₚ ⊢ₑ) (D-β-φ V) P₀ (D-β-+ Vₗ Vᵣ) = P₀ (⊢-φ ⊢ₚ ⊢ₑ)
⇐-preserve (⊢-φ ⊢ₚ ⊢ₑ) (D-β-φ V) P₀ (D-β-φ V₁) = P₀ (⊢-φ ⊢ₚ ⊢ₑ)
⇐-preserve (⊢-φ ⊢ₚ ⊢ₑ) (D-β-φ V) P₀ (D-β-δ V₁) = P₀ (⊢-φ ⊢ₚ ⊢ₑ)
⇐-preserve (⊢-δ {r = a , 𝟙 , l} ⊢) (D-ξ-δ D) P₀ C = ⇐-preserve ⊢ D P₀ C
⇐-preserve (⊢-δ {r = a , ⋆ , l} ⊢) (D-ξ-δ D) P₀ (D-ξ-δ C) = ⊢-δ (⇐-preserve ⊢ D P₀ C)
⇐-preserve (⊢-δ {r = a , 𝟙 , l} ⊢) (D-β-δ V) P₀ (D-β-· Vₗ Vᵣ) = P₀ (⊢-δ ⊢)
⇐-preserve (⊢-δ {r = a , ⋆ , l} ⊢) (D-β-δ V) P₀ (D-β-· Vₗ Vᵣ) = P₀ (⊢-δ ⊢)
⇐-preserve (⊢-δ {r = a , 𝟙 , l} ⊢) (D-β-δ V) P₀ (D-β-+ Vₗ Vᵣ) = P₀ (⊢-δ ⊢)
⇐-preserve (⊢-δ {r = a , ⋆ , l} ⊢) (D-β-δ V) P₀ (D-β-+ Vₗ Vᵣ) = P₀ (⊢-δ ⊢)
⇐-preserve (⊢-δ {r = a , 𝟙 , l} ⊢) (D-β-δ V) P₀ (D-β-φ V₁) = P₀ (⊢-δ ⊢)
⇐-preserve (⊢-δ {r = a , ⋆ , l} ⊢) (D-β-δ V) P₀ (D-β-φ V₁) = P₀ (⊢-δ ⊢)
⇐-preserve (⊢-δ {r = a , 𝟙 , l} ⊢) (D-β-δ V) P₀ (D-β-δ V₁) = P₀ (⊢-δ ⊢)
⇐-preserve (⊢-δ {r = a , ⋆ , l} ⊢) (D-β-δ V) P₀ (D-β-δ V₁) = P₀ (⊢-δ ⊢)
...
↦-preserve (⊢-` ∋) (step () T C)
↦-preserve (⊢-ƛ ⊢) (step () T C)
↦-preserve (⊢-· ⊢ₗ ⊢ᵣ) (step (D-ξ-·ₗ D) T (D-ξ-·ₗ C)) = ⊢-· (↦-preserve ⊢ₗ (step D T C)) ⊢ᵣ
↦-preserve (⊢-· ⊢ₗ ⊢ᵣ) (step (D-ξ-·ᵣ V D) T (D-ξ-·ᵣ V₁ C)) = ⊢-· ⊢ₗ (↦-preserve ⊢ᵣ (step D T C))
